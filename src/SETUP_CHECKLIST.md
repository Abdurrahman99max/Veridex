...
- [ ] Copy entire contents of `/database/bootstrap.sql`
- [ ] Paste and click **"RUN"**
...
- [ ] In **SQL Editor**, create new query
- [ ] Copy entire contents of `/database/test_data.sql`
- [ ] Paste and click **"RUN"**
...
- [ ] In **SQL Editor**, create new query
- [ ] Copy entire contents of `/database/verify_setup.sql`
- [ ] Paste and click **"RUN"**
...
#### Test 12.1: View Applicants
- [ ] Click **"Applicants"** tab
- [ ] Verify: You see test applicants (if test data was loaded)
- [ ] Try filters: **All**, **Core**, **Prep**
- [ ] Try search bar: Type a name
- [ ] **Time**: ~1 minute

#### Test 12.2: View Applicant Details
- [ ] Click on any applicant card
- [ ] Verify: Side panel opens with full details
- [ ] Scroll down to see:
  - [ ] Proof URL link
  - [ ] Admin feedback section
  - [ ] Reliability tier selector
  - [ ] Audit logs for this applicant
- [ ] Click **X** to close panel
- [ ] **Time**: ~1 minute

#### Test 12.3: Update Applicant Status (Safety Interlock Test)
- [ ] Click on an applicant with status "APPLIED"
- [ ] Click **"Verify"** button
- [ ] Verify: **Safety Interlock** dialog appears
- [ ] Read the warning message
- [ ] Type justification: "Testing admin system setup"
- [ ] Check ✅ "I confirm this action"
- [ ] Click **"Execute: Verify Applicant"**
- [ ] Verify: Toast notification appears: "Status update successful"
- [ ] Verify: Applicant card updates to "ACCEPTED" with green badge
- [ ] **Time**: ~2 minutes

#### Test 12.4: View Audit Logs
- [ ] Click **"Audit Logs"** tab
- [ ] Verify: You see human-readable logs like:
  - "Super Admin verified Marcus Johnson on Mar 01, 2026"
  - "Super Admin flagged Emily Rodriguez on Mar 06, 2026"
- [ ] Verify: Your test action from 12.3 appears at the top
- [ ] **Time**: ~1 minute

#### Test 12.5: Add Team Member
- [ ] Click **"Team"** tab
- [ ] Verify: You see yourself listed as "Super Admin"
- [ ] In "Grant Admin Access" section:
  - [ ] Enter email: `test.admin@example.com`
  - [ ] Enter name: `Test Admin`
  - [ ] Select role: **Admin**
  - [ ] Click **"Grant Access"**
- [ ] Verify: Toast notification: "Access granted to test.admin@example.com"
- [ ] Verify: New admin appears in team list
- [ ] **Time**: ~2 minutes

#### Test 12.6: Check Email Notification (Optional)
- [ ] Check your inbox: `onitiloabdurrahman@gmail.com`
- [ ] Look for email from **Veridex** (noreply@your-domain.com)
- [ ] Subject: "New Admin Added to Veridex"
- [ ] Verify: Email contains details about test.admin@example.com
- [ ] **Time**: ~1 minute (email may take 1-2 min to arrive)

#### Test 12.7: Issue a Strike
- [ ] Go back to **"Applicants"** tab
- [ ] Click on an ACCEPTED applicant
- [ ] Click **"⚡ Issue Strike"** button
- [ ] Select strike type: **"Missed Commitment"**
- [ ] Enter reason: "Testing strike system"
- [ ] Safety Interlock appears:
  - [ ] Read warning
  - [ ] Enter justification
  - [ ] Check ✅ confirmation
  - [ ] Click **"Execute: Issue Strike"**
- [ ] Verify: Toast notification appears
- [ ] Verify: Strike count increases in applicant card
- [ ] Verify: New audit log entry created
- [ ] **Time**: ~2 minutes

#### Test 12.8: Session Timeout (Optional - Long Test)
- [ ] Note current time
- [ ] Leave browser tab open but **don't interact** for 30 minutes
- [ ] After 30 minutes of inactivity:
  - [ ] Verify: Toast notification: "Session expired for security"
  - [ ] Verify: Redirected to login page
  - [ ] Verify: URL shows `/?dex=1`
- [ ] **Time**: 30+ minutes (can skip and test later)

---

## ✅ FINAL VERIFICATION

### Step 13: Complete System Health Check
...
- **Deployment Issues**: Check Vercel/hosting logs
- **Code Issues**: Review GitHub PR changes

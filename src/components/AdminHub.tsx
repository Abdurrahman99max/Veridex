            ...
            <div className="p-6 space-y-4">
              ...
              {auditLogs.length === 0 ? (
                ...
                const action = actionMap[log.action_type] || { 
                  label: (log.action_type || 'UNKNOWN_ACTION').replace(/_/g, ' '), 
            ...
            <div className="p-6 max-w-4xl mx-auto space-y-8">
                    ...
                    {showBulkImport ? (
                      <>
                        <textarea
                          ...
                          className={`${inputBg} border border-white/10 rounded-lg px-4 py-3 text-sm focus:ring-1 focus:ring-indigo-500 outline-none w-full min-h-[120px] resize-y font-mono`}
                          value={bulkEmails}
                          onChange={(e) => setBulkEmails(e.target.value)}
                        />
                        <div className="flex gap-4">
                          <Select value={selectedRole} onValueChange={(val) => setSelectedRole(val as AdminRole)}>
                            <SelectTrigger className={`flex-1 ${inputBg} border border-white/10`}>
                      ...
                      <>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <input 
                            ...
                            className={`${inputBg} border border-white/10 rounded-lg px-4 py-2.5 text-sm focus:ring-1 focus:ring-indigo-500 outline-none`} 
                            value={newTeamMember} 
              ...
              <div className={`${surfaceColor} border ${borderColor} rounded-xl overflow-hidden`}>
                <div className="p-4 border-b border-white/5">
                  <h3 className="text-sm font-bold uppercase tracking-widest opacity-70">Team Members ({whitelist.length})</h3>
                </div>
        ...
        {showPolicyProposal && (
          <div className="fixed inset-0 z-[300] flex items-center justify-center p-6">
            ...
            <motion.div
              ...
              className={`${surfaceColor} border ${borderColor} rounded-2xl p-8 max-w-2xl w-full relative z-10 shadow-2xl`}
            >
              <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full ${inputBg} border border-white/10 rounded-lg px-4 py-2 text-sm`}
                      />
                    </div>
                    <div>
